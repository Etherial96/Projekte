Um den Chatbot in der SpringBoot Anwendung(Website) nutzen zu können, muss lokal ein Image für den Docker erstellt werden. Die Dateien dazu findet man unter: Chatbots/chatbotausInternet/...
