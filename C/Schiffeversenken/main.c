...
int main(int argc, char *argv[]) {
	...
	printf("Sie haben das Spiel gestartet\n\n    ");
	...
	switch(schiffer)
	{
		...
		case 2:
		{
				...
				switch(wagesenk)
				{
					case 1:
					{
						...
						else if(zaehlery < 1 && brett[zaehlery][zaehlerx] || brett[zaehlery-1][zaehlerx]
												|| brett[zaehlery][zaehlerx +1] || brett[zaehlery-1][zaehlerx+1]
											 	|| brett[zaehlery][zaehlerx -1] || brett[zaehlery-1][zaehlerx-1]
											 	|| brett[zaehlery+1][zaehlerx]	|| brett[zaehlery-2][zaehlerx] == 0)
						{	zbootp++;
				...
				else if(zaehlerx < 1 && brett[zaehlery][zaehlerx] || brett[zaehlery][zaehlerx-1] == 0
							|| brett[zaehlery+1][zaehlerx]  || brett[zaehlery+1][zaehlerx-1]
							|| brett[zaehlery-1][zaehlerx]  || brett[zaehlery-1][zaehlerx-1]
							|| brett[zaehlery][zaehlerx+1]	|| brett[zaehlery][zaehlerx-2] == 0)
						{	zbootp++;
		...
		case 3:
		{
			if(dbootx > 0)
			{
				...
				switch(wagesenk)
				{
					...
					else if(zaehlery > 1 && brett[zaehlery][zaehlerx] || brett[zaehlery -1][zaehlerx] || brett[zaehlery -2][zaehlerx] 
							|| brett[zaehlery][zaehlerx +1] || brett[zaehlery-1][zaehlerx+1]
							|| brett[zaehlery][zaehlerx -1] || brett[zaehlery-1][zaehlerx-1]
							|| brett[zaehlery-2][zaehlerx-1]|| brett[zaehlery-2][zaehlerx+1]
							|| brett[zaehlery+1][zaehlerx]	|| brett[zaehlery-3][zaehlerx]== 0)
		...
		case 2:
			...
			break;
				...
				else if(zaehlerx > 1 && brett[zaehlery][zaehlerx] || brett[zaehlery][zaehlerx -1] || brett[zaehlery][zaehlerx -2]
					|| brett[zaehlery+1][zaehlerx]== 0 || brett[zaehlery+1][zaehlerx-1]== 0
					|| brett[zaehlery-1][zaehlerx]== 0 || brett[zaehlery-1][zaehlerx-1]== 0
					|| brett[zaehlery+1][zaehlerx-2]== 0|| brett[zaehlery-1][zaehlerx-2]== 0
					|| brett[zaehlery][zaehlerx+1]== 0	|| brett[zaehlery][zaehlerx-3] == 0)
		...
		break;
			...
			else if(zaehlery > 2 && brett[zaehlery][zaehlerx] || brett[zaehlery -1][zaehlerx] || brett[zaehlery -2][zaehlerx] || brett[zaehlery -3][zaehlerx] 
						|| brett[zaehlery][zaehlerx +1] || brett[zaehlery-1][zaehlerx+1]
						|| brett[zaehlery][zaehlerx -1] || brett[zaehlery-1][zaehlerx-1]
						|| brett[zaehlery-2][zaehlerx-1]|| brett[zaehlery-2][zaehlerx+1]
						|| brett[zaehlery-3][zaehlerx-1]|| brett[zaehlery-3][zaehlerx+1]
			...
			{	
				...
				else if(zaehlerx > 2 && brett[zaehlery][zaehlerx] || brett[zaehlery][zaehlerx +1] || brett[zaehlery][zaehlerx +2] || brett[zaehlery][zaehlerx +3] 
					|| brett[zaehlery+1][zaehlerx]  || brett[zaehlery+1][zaehlerx-1]
					|| brett[zaehlery-1][zaehlerx]  || brett[zaehlery-1][zaehlerx-1]
					|| brett[zaehlery+1][zaehlerx-2]|| brett[zaehlery-1][zaehlerx-2]
					|| brett[zaehlery-1][zaehlerx-3]|| brett[zaehlery+1][zaehlerx-3]
